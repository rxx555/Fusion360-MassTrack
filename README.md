...
A Fusion 360 add-in that tracks the mass of the parts you mark and exports them to an Excel workbook, per component or body, with history and charts.
...
1. Download `dist/MassTrack_addin.zip` and unzip it to get a `MassTrack` folder.
